...
const ProductPage = ({ products, addProductToCart, removeProductFromCart }) => {
  return (
    <WrapperBox>
      <Typography
        p="0.5rem"
...
const ProductOne = ({ product, addProductToCart, removeProductFromCart }) => {
  return (
    <WrapperBox>
      <Typography
        p="0.5rem"
...
const ProductTwo = ({ product, addProductToCart, removeProductFromCart }) => {
  return (
    <WrapperBox>
      <Typography
        p="0.5rem"
